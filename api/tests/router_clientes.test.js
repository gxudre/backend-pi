...
describe('API Loja Virtual', () => {
    Test('Deve retornar 201 e um JSON no POST /clientes', async () => {
        const response = await request.post('/clientes').send({nome: 'julia', telefone: 61999888777, email: 'julia@gmail.com', endereco: "Condominio velavilaqua quadra 5 casa 22"});
